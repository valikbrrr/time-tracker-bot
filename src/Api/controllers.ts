...
export const addToMonthController = async (
  userName: string,
  userId: string,
  hoursInMonth: string,
...
export const addToProjectController = async (
  userName: string,
  userId: string,
  hoursInMonth: string,
...
export const viewMonthController = async (
  userId: string,
  ...
  try {
    logger.info(
      `Received userId: ${userId}, userSelectMonth: ${userSelectMonth}`
    );
...
export const viewProjectController = async (
  userId: string,
